...
<style>
  ...
  /* Suppress raw icon text strings (e.g. _arrow_right, keyboard_double_arrow_left) */
  ...
  [data-testid="stSidebar"] [data-testid="stExpander"] summary span[data-testid="stExpanderToggleIcon"],
  [data-testid="stSidebar"] [data-testid="stExpander"] summary > div > p:first-child {{
      display: none !important;
  }}
  /* Hide any element whose text content is purely an icon name */
  [data-testid="stSidebar"] .stExpanderHeader [data-baseweb="icon"],
  [data-testid="stSidebar"] span.material-icons-sharp,
  [data-testid="stSidebar"] span[class*="MaterialIcon"],
  [data-testid="stSidebar"] [aria-label*="arrow"] span {{
      font-size: 0 !important;
      width: 20px;
...
_tab_labels = ["Price & Returns", "Risk & Distribution", "Correlation & Diversification"]
